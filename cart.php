...
if (isset($_POST['update_cart'])) {
    ...
    mysqli_query(
        $conn,
        "UPDATE `cart` SET quantity = '$cart_quantity' WHERE id = '$cart_id'"
    ) or die('query failed');
...
<body>
    ...
    <div class="heading">
        <h3>winkel wagen</h3>
        <p> <a href="winkel.php">home</a> / winkelwagen </p>
    </div>

    <section class="shopping-cart">

        <h1 class="title">jouw Winkelwagen</h1>
        ...
        <div class="box-container">
            ...
            <div class="box">
                <a href="cart.php?delete=<?php echo $fetch_cart[
                    'id'
                ...
                <form action="" method="post">
                    <input type="hidden" name="cart_id" value="<?php echo $fetch_cart[
                        'id'
                    ]; ?>">
                    <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart[
                        'quantity'
                    ]; ?>">
        ...
        <div style="margin-top: 2rem; text-align:center;">
            ...
            1
                ? ''
                : 'disabled'; ?>" onclick="return confirm('delete all from cart?');">verwijder alles</a>
        </div>

        <div class="cart-total">
            <p>total : <span>€<?php echo $grand_total; ?>/-</span></p>
            <div class="flex">
                <a href="winkel.php" class="option-btn">verder winkelen</a>
                <a href="afrekenen.php" class="btn <?php echo $grand_total > 1
                    ? ''
                    : 'disabled'; ?>">naar afrekening</a>
            </div>
        </div>
